...
exports.TGACollector = void 0;
const BaseCollector_1 = require("../core/BaseCollector");
const cheerio = __importStar(require("cheerio"));
const uuid_1 = require("uuid");
class TGACollector extends BaseCollector_1.BaseCollector {
    searchUrl = 'https://www.tga.gov.au/resources/artg';
    apiBaseUrl = 'https://www.tga.gov.au/api/artg';
    constructor() {
        super({
            sourceType: 'TGA',
...
exports.TGACollector = TGACollector;
//# sourceMappingURL=TGACollector.js.map