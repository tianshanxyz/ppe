...
const DEMO_TASKS: ComplianceTask[] = [
  {
    ...
    reminders: [
      { date: '2024-05-15', note: 'Follow up with NIOSH on test results' },
      { date: '2024-06-01', note: 'Submit 510(k) application' },
    ],
  },
  {
    id: '2',
    ...
    reminders: [
      { date: '2024-05-01', note: 'Check Notified Body review status' },
    ],
  },
  {
    id: '3',
