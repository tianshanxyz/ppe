...
const DEMO_ALERTS: RegulatoryAlert[] = [
  {
    id: '1',
    title: 'EU PPE Regulation (EU) 2016/425 Amendment 2026',
    description: 'New amendment introduces updated conformity assessment procedures for Category III PPE. Manufacturers must update technical documentation by December 2026.',
    severity: 'critical',
    category: 'regulation',
    marketCode: 'EU',
  ...
  },
  {
    ...
    description: 'UK government extends recognition of CE marking for PPE products until December 2026. Manufacturers can continue using CE marking on UK market.',
    severity: 'medium',
    category: 'regulation',
    marketCode: 'UK',
    categoryIds: ['respiratory-protection', 'protective-clothing', 'safety-footwear', 'protective-gloves', 'eye-protection'],
