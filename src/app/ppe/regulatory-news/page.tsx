...
const DEMO_NEWS: RegulatoryNews[] = [
  {
    id: '1',
    title: 'EU PPE Regulation: 2026 Update Guide for Manufacturers',
  ...
  {
    id: '2',
    title: 'U.S. PPE Market Reaches $9.5B in 2026, Driven by Industrial Safety Demand',
    summary: 'Market analysis shows continued growth in U.S. PPE market with industrial safety segment leading at 37% market share.',
    content: 'The U.S. personal protective equipment market has reached $9.5 billion in 2026, representing a 7.2% year-over-year growth. Key findings: Industrial safety applications account for 37% of total market value; Healthcare PPE segment shows stabilization post-pandemic; Respiratory protection remains the fastest-growing category at 14% CAGR; Online distribution channels now represent 32% of sales. Regional analysis shows strongest growth in Texas, California, and Ohio manufacturing corridors. Import data indicates China remains the dominant supplier (42% share), followed by Mexico (20%) and domestic manufacturing (25%).',
    category: 'market',
    marketCode: 'US',
  ...
  {
    id: '3',
    title: 'China NMPA Streamlines PPE Registration Process with Enhanced Digital Platform',
    summary: 'NMPA enhances online registration system reducing processing time by 50% for Class I and II medical PPE products.',
    content: 'The National Medical Products Administration (NMPA) has enhanced its digital registration platform for medical devices including PPE. The platform introduces: 1) Online submission of technical documentation; 2) Real-time tracking of application status; 3) Electronic certificate issuance; 4) AI-assisted document checking with automated preliminary review. Users report average processing time reduction from 120 days to 60 days for Class I products, and from 180 days to 90 days for Class II products. The platform is now mandatory for all new applications.',
    category: 'regulation',
    marketCode: 'CN',
  ...
  {
    id: '4',
    title: 'UK Updates UKCA Marking Requirements for PPE in 2026',
    summary: 'UK government updates UKCA marking guidance with streamlined procedures for PPE manufacturers.',
    content: 'The UK Department for Business and Trade has published updated guidance on UKCA marking for PPE products. Key updates include: 1) Simplified conformity assessment procedures for low-risk PPE; 2) Extended recognition of EU test reports for UKCA certification; 3) Digital labeling options for certain PPE categories; 4) Updated list of UK Approved Bodies. UKCA marking remains mandatory for the Great Britain market. Northern Ireland continues to accept CE marking under the Windsor Framework. Manufacturers are advised to review the updated guidance to ensure continued compliance.',
    category: 'regulation',
    marketCode: 'UK',
  ...
  {
    id: '5',
    title: 'New ISO Standard for Smart PPE Published: ISO 45006:2026',
    ...
    content: 'ISO has published ISO 45006:2026, the international standard specifically addressing smart PPE. The standard covers: 1) Safety requirements for PPE with embedded sensors and connectivity; 2) Data privacy and security requirements including GDPR compliance; 3) Electromagnetic compatibility; 4) Battery safety and charging systems; 5) Software validation and update procedures; 6) AI/ML integration guidelines. The standard applies to PPE with integrated IoT capabilities including smart helmets, connected safety vests, and biometric monitoring devices. Compliance is voluntary but expected to become a market requirement within 2-3 years.',
    category: 'technology',
    marketCode: 'EU',
  ...
  },
  {
    ...
    summary: 'SASO PPE Technical Regulation becomes mandatory with full enforcement starting April 2026.',
    content: 'The Saudi Standards, Metrology and Quality Organization (SASO) has announced full enforcement of the PPE Technical Regulation starting April 1, 2026. All PPE products must now have: 1) Valid SASO Quality Mark or IECEE Certificate with Saudi national difference; 2) Arabic labeling and user instructions; 3) Registration in the SABER electronic platform; 4) Product Certificate of Conformity (PCoC) and Shipment Certificate of Conformity (SCoC). Products without proper certification will be rejected at Saudi customs. The regulation covers all PPE categories including head, eye, respiratory, hand, foot, and body protection.',
    category: 'regulation',
    marketCode: 'GCC',
  ...
  {
    id: '7',
    title: 'Global PPE Supply Chain: 2026 Outlook and Risk Assessment',
