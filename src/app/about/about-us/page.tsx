...
import { Database, Globe, Shield, TrendingUp, Users, Lock } from 'lucide-react'
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <FeatureCard icon={Database} title={t.comprehensiveDatabase} description={t.comprehensiveDatabaseDesc} />
            <FeatureCard icon={Shield} title={t.regulatoryCompliance} description={t.regulatoryComplianceDesc} />
            <FeatureCard icon={TrendingUp} title={t.realTimeUpdates} description={t.realTimeUpdatesDesc} />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <DataSourceCard flag="🇺🇸" name={t.fdaUS} description={t.fda510k} />
            <DataSourceCard flag="🇪🇺" name={t.eudamedEU} description={t.eudamedRegistrations} />
            <DataSourceCard flag="🇬🇧" name="MHRA (UK)" description={isZh ? 'UKCA认证注册数据' : 'UKCA certification registry'} />
            <DataSourceCard flag="🇨🇦" name="Health Canada" description={isZh ? '医疗器械注册数据库' : 'Medical device registry'} />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <ValueCard icon={Users} title={t.accessibility} description={t.accessibilityDesc} />
            <ValueCard icon={Lock} title={t.transparency} description={t.transparencyDesc} />
            <ValueCard icon={Shield} title={t.accuracy} description={t.accuracyDesc} />
          </div>
        </section>
